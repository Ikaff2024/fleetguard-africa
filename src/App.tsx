  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0b0f19] text-slate-900 dark:text-slate-100 font-sans flex flex-col selection:bg-orange-500 selection:text-white transition-colors duration-200">
      ...
      {isNightDispatcher && (
        <div className="bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-orange-300 text-[11px] font-medium px-4 py-1.5 border-b border-orange-500/20 flex items-center justify-between gap-2 shadow-xs shrink-0">
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-300 hidden sm:inline">Rétroéclairage adouci et élimination de la lumière bleue pour garde nocturne 12h.</span>
          </div>
      ...
      <footer className="bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 px-6 py-2.5 text-[11px] text-slate-500 dark:text-slate-400 flex flex-wrap items-center justify-between gap-2 shrink-0 transition-colors">
        <div className="flex items-center gap-3">
          <span className="font-semibold text-slate-700 dark:text-slate-300">FleetGuard Africa MVP © 2026</span>
          <span>•</span>
          ...
          <span>•</span>
          <span>Tenant Actif: <strong className="text-slate-800 dark:text-slate-200">{currentOrg.name}</strong> ({currentOrg.code})</span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <span>Réseau :</span>
            <span className={isOnline ? 'text-emerald-600 dark:text-emerald-400 font-bold bg-emerald-50 dark:bg-emerald-950/50 px-2 py-0.5 rounded border border-emerald-200 dark:border-emerald-800' : 'text-red-600 dark:text-red-400 font-bold bg-red-50 dark:bg-red-950/50 px-2 py-0.5 rounded border border-red-200 dark:border-red-800'}>
